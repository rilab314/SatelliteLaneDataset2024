...
if __name__ == '__main__':
    label_drive = "/media/falcon/50fe2d19-4535-4db4-85fb-6970f063a4a11/Ongoing/2024_SATELLITE/datasets/total_origin_lonlat/segmentation_label"
    coords_save_path = '/media/falcon/50fe2d19-4535-4db4-85fb-6970f063a4a11/Ongoing/2024_SATELLITE/datasets/total_origin_lonlat/dataset.json'
    generate_train_val_coords(label_drive, coords_save_path, lon_range=[127.0648, 127.1695], lat_range=[37.4776, 37.5636])


    # root_path = '/media/falcon/50fe2d19-4535-4db4-85fb-6970f063a4a11/Ongoing/2024_SATELLITE/datasets/satellite_segmentation_241113'
    save_path = '/media/falcon/50fe2d19-4535-4db4-85fb-6970f063a4a11/Ongoing/2024_SATELLITE/datasets/satellite_detectron_241114'
    root_path = '/media/falcon/50fe2d19-4535-4db4-85fb-6970f063a4a11/Ongoing/2024_SATELLITE/datasets/total_origin_lonlat'
    divide_train_val(root_path, save_path, coords_save_path)
    # os.makedirs(os.path.join(save_path, 'images', 'training'), exist_ok=True)
    # os.makedirs(os.path.join(save_path, 'images', 'validation'), exist_ok=True)
    # os.makedirs(os.path.join(save_path, 'annotations_detectron2', 'training'), exist_ok=True)
    # os.makedirs(os.path.join(save_path, 'annotations_detectron2', 'validation'), exist_ok=True)
    #
    # for coord in tqdm(dataset['train'], desc='Copy training dataset'):
    #     label_path = os.path.join(root_path, 'detectron_label', coord+'.png')
    #     moved_label_path = os.path.join(save_path, 'annotations_detectron2', 'training', coord+'.png')
    #     shutil.copy(label_path, moved_label_path)
    #     image_path = os.path.join(root_path, 'image', coord+'.png')
    #     moved_image_path = os.path.join(save_path, 'images', 'training', coord+'.png')
    #     shutil.copy(image_path, moved_image_path)
    #
    # for coord in tqdm(dataset['validation'], desc='Copy validation dataset'):
    #     label_path = os.path.join(root_path, 'detectron_label', coord+'.png')
    #     moved_label_path = os.path.join(save_path, 'annotations_detectron2', 'validation', coord+'.png')
    #     shutil.copy(label_path, moved_label_path)
    #     image_path = os.path.join(root_path, 'image', coord+'.png')
    #     moved_image_path = os.path.join(save_path, 'images', 'validation', coord+'.png')
    #     shutil.copy(image_path, moved_image_path)
