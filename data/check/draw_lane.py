...
if __name__ == '__main__':
    ...
    label_paths = sorted(glob(os.path.join("/media/falcon/50fe2d19-4535-4db4-85fb-6970f063a4a11/Ongoing/2024_SATELLITE/datasets/satellite_dataset_241111/segmentation_label", "*.json")))

    for label_path in label_paths:
        img_path = label_path.replace("segmentation_label", "image").replace(".json", ".png")
